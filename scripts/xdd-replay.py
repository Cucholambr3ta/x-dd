...
from _xdd_common import make_parser, read_version, utcnow_iso_us as utcnow_iso  # noqa: E402
...
def build_parser():
    p, _ = make_parser("xdd-replay", __doc__, with_subcommands=False, raw_description=True, short_version_flag=False)
