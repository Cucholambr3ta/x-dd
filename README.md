...
[![Constitución](https://img.shields.io/badge/Constituci%C3%B3n-v1.4-blue)](docs/constitucion.md)
[![Agentes](https://img.shields.io/badge/agentes-180-blueviolet)](prompts/agents/registry.json)
[![ADRs](https://img.shields.io/badge/ADRs-42-purple)](docs/adr/)
...
| **Gobernanza** | [Constitución v1.4](docs/constitucion.md) + Gate keeper criptográfico que bloquea avances de fase sin aprobación firmada |
...
| **Trazabilidad** | **42** ADRs (`docs/adr/`), **55** workflows, CHANGELOG + releases versionados |
| **Calidad** | Suite de tests pytest + bats + AgentShield (audit estático del framework) |
...
- **AgentShield** — audit estático de seguridad del propio framework (`xdd-shield.py`): reglas sobre hooks, agentes, MCP tools y workflows.
- **MCP server propio** — `xdd-mcp-server` (Python stdlib pura) expone agentes, workflows y artefactos vía Model Context Protocol.
- **Instalación modular** — perfiles `minimal | core | developer | security | research | full` con manifests declarativos validados por JSON Schema.
...
Según la [Constitución Art. 7](docs/constitucion.md): `main` protegida (integración solo vía PR con aprobación humana), nomenclatura de ramas estándar, y revisión de calidad antes de cada merge.

## Documentación

- [Constitución](docs/constitucion.md) — ley suprema del ecosistema
...
- [ADRs](docs/adr/) — 42 decisiones arquitectónicas
